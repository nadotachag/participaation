...
$lignes=5;//nombre de lignes multicolore qui seront affichées avec le code (10 est bien)
$caracteres="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";//type de caractère du code qui sera affiché dans l'image
...
$_SESSION['code_inscription']=$code1;//on enregistre le code dans une session pour vérifier ensuite se qu'à entré le visiteur est identique
...
// $font = imageloadfont('HomBoldB_16x24_BE.gdf');
