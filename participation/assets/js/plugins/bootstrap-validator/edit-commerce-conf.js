...
//      live: 'disabled',
            ...
            titreCom: {
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 80,
                        message: 'Le nom doit comporCom plus de 2 caractères et moins de 20 caractères'
                    },
                }
            },
            superficieCom: {
			...
			villeCom: {
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 60,
                        message: 'Le nom doit comporCom plus de 2 caractères et moins de 60 caractères'
                    },
                }
            },
            adresseCom: {
        ...
        onSuccess: function(e, data) {
            ...
            function uploadImage($form){
              ...
              request.open('post', 'handler/edit-commerce.php');
